...
namespace Workfolio\Settings\Admin;

use Backdrop\Contracts\Bootable;
use Workfolio\Settings\Admin\Views;
use function Backdrop\Mix\asset;
use Workfolio\Settings\Manager\Themes;
	...
	public function template() { ?>
		...
		<div class="wrap">
			...
			<?php if ( current_user_can( 'customize' ) ) : ?>
				<a href="<?php esc_url( wp_customize_url() ) ?>" class="hide-if-no-js page-title-action"><?php esc_html_e( 'Customize', 'backdrop' ) ?></a>
			<?php endif ?>
