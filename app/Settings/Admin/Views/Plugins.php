...
use Workfolio\Settings\Manager\Plugins\Plugins as PluginCollection;
...
class Plugins extends View {
	...
	public function register() {
		...
		// Register plugins.
		add_action( 'backdrop/settings/admin/view/plugins/register', [ $this, 'registerDefaultPlugins' ] );
	}
	...
	public function boot() {
		...
		do_action( 'backdrop/settings/admin/view/plugins/register', $this->plugins );
	}
	...
	public function template() { ?>
		<header>
			<h1><?php esc_html_e( 'Recommended Plugins', 'backdrop' ) ?></h1>
        </header>
        <p>
            <?php esc_html_e( 'Clean up unnecessary items on the front end of your site for speed improvements.', 'backdrop' ) ?>
        </p>
